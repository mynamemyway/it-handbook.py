...
> ⚠️ Корректировка ошибки оригинала: в присланном решении отсутствовал блок `ORDER BY`, хотя в условии задания явно требовалось отсортировать результат «сначала по фамилии водителя, потом по номеру машины и, наконец, по нарушению». Без сортировки порядок строк в SQL не гарантирован.
