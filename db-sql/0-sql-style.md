...
«SQL: Руководство по стилю» (SQL style guide) за авторством Саймона Холиуэлла (Simon Holywell) находится под лицензией Creative Commons «Атрибуция — На тех же условиях» 4.0 Всемирная. Оригинал — https://www.sqlstyle.guide.
...
- **Дата и время**: Соответствующие стандарту ISO 8601: YYYY-MM-DDTHH:MM:SS.SSSSS
- **Функции SQL**: Стандартные вместо специфичных (определяемых поставщиком) для лучшей переносимости
- **Код**: Лаконичный, без излишеств, напр.: лишние кавычки или скобки, неуместное использование WHERE
...
- **Принципы ООП**: Не нужно применять к SQL или структуре базы данных

## Соглашения о наименовании

### Общее
- Убедитесь в том, что имя уникально и его нет в списке зарезервированных ключевых слов.
- Ограничивайте длину имени 30 байтами (30 символов, если не используется многобайтный набор символов).
...
- Используйте символ подчёркивания там, где вы бы поставили пробел в реальной жизни.
...
- Названия всегда пишите со строчной буквы. Могут быть исключения - использование имени собственного.

### Псевдонимы/корреляции
- Должны быть связаны с объектами или выражениями, псевдонимом которых они являются.
...
- Не применяйте ООП, т.к. они не всегда оптимально ложатся на реляционную модель баз данных.
